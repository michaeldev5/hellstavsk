  ...
  <section className="text-gray-600 body-font">
    <div className="container px-5 pt-24 mx-auto">
      ...
      <div className="flex flex-wrap -m-4">
        <FeatureItem
          title="Kvalita"
          content="Výber kvalitných stavebných materiálov je jedným z hlavných pilierov úspešného projektu. Pomôžeme Vám!"
          icon={
            <svg
              fill="none"
              stroke="currentColor"
        ...
        <FeatureItem
          title="Odbornosť"
          content="Dlhodobá práca v našom odbore bola pevným základom mnohých našich už ukončených úspešných projektov."
          icon={
            <svg
              fill="none"
              stroke="currentColor"
